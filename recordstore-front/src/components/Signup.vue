...
<!--      <h3 class="text-2xl mb-6 text-grey-light-darkest">Sign Up</h3>-->
...
<!--        <button type="submit" class="font-sans font-bold px-4 rounded cursor-pointer no-underline bg-green-500 hover:bg-green-900 block w-full py-4 text-white items-center justify-center">Sign Up</button>-->
